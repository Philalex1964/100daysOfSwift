// 100 Days of Swift
// Day 9. Structs. Part 2. – access control, static properties, and laziness
...
var user1 = User1()
user1.username
user1.username = "Philalex"

//How do Swift’s memberwise initializers work? Как работают поэлементные инициализаторы Swift?
/*
...
//let roslin1 = Employee1(name: "Laura Roslin")
...
// 2. Referring to the current instanceReferring to the current instance. SELF
/*
...
var student = Student(name: "Ivan", bestFriend: "Maria")
...
//error: Day9_Structs_partII.playground:168:22: error: incorrect argument labels in call (have 'nameEnglish:nameLocal:speakerCount:', expected 'english:local:speakerCount:')
...
/*
 ...
 First, my Unwrap struct isn’t really a struct at all – I actually declare it as an enum rather than a struct. The enum doesn’t have any cases, but it’s a better choice than a struct here because I don’t ever want to create an instance of this type – there’s no reason to. Making an enum stops this from happening, which helps clarify my intent.
...
let stas = Person4(id: "12345")
//stas.id //'id' is inaccessible due to 'private' protection level
